    ...
    <div class="sidebar-content js-simplebar">
      ...
      <ul class="sidebar-nav">
        ...
        <li class="sidebar-item ">
          <a class="sidebar-link" href="<%=request.getContextPath()%>/OrderServlet?action=GetAll">
      ...
      <div class="container-fluid p-0">
        <form action="<%=request.getContextPath()%>/ProductServlet" method="post" enctype="multipart/form-data">
          <table>
            <tr>
              <td>Product ID</td>
              <td><input type="text" name="productID" readonly value="${updateProduct.productID}"/></td>
            </tr>
            <tr>
              <td>Product Name</td>
            ...
            <tr>
              <td>Title</td>
              <td><input type="text" name="productTitle" value="${updateProduct.productTitle}"/></td>
            </tr>
            <tr>
              <td>Category</td>
              <td>
                <select id="catalogID" name="catalog">
                  <c:forEach items="${listShortCatalog}" var="cat">
                    <option value="${cat.catalogID}" ${cat.catalogID==updateProduct.catalog?'selected':''}>${cat.catalogName}</option>
                  </c:forEach>
                </select>
              </td>
            </tr>
            <tr>
              ...
              <td><input type="file" name="productImage"/>
                <img width="100" height="100" src="<%=request.getContextPath()%>/views/img/product-img/${updateProduct.productImage}" alt="${updateProduct.productName}">
                <input type="hidden" name="oldImage" value="${updateProduct.productImage}">
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Description</td>
              <td><textarea name="descriptions" id="descriptions">${updateProduct.descriptions}</textarea></td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <a href="<%=request.getContextPath()%>/ProductServlet?action=GetAll"><button>Go Back</button></a>
              </td>
            </tr>
          </table>
        </form>
