    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="<%=request.getContextPath()%>/index.jsp">
            ...
            <div class="container-fluid p-0">
                <form action="<%=request.getContextPath()%>/ProductServlet" method="post" enctype="multipart/form-data">
                    <table>
                        ...
                        <tr>
                            <td>Title</td>
                            <td><input type="text" required name="productTitle"/></td>
                        </tr>
                        <tr>
                            <td>Category</td>
                            <td>
                                <select id="catalogID" required name="catalog">
                        ...
                        <tr>
                            <td>Product Image</td>
                            <td><input type="file" required name="productImage" id="productImage"/></td>
                        </tr>
                        <tr>
                            <td>Product Sub Images</td>
                            <td><input type="file" required name="subImages" id="subImages" multiple/></td>
                        </tr>
                        <tr>
                            <td>Description</td>
                            <td><textarea name="descriptions" required id="descriptions"></textarea></td>
                        </tr>
                        <tr>
                            <td colspan="2">
