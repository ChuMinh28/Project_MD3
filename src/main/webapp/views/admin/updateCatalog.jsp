        ...
        <main class="content">
            <div class="container-fluid p-0">
                <form action="<%=request.getContextPath()%>/catalogController/update" method="post">
                    <table>
                        <tr>
                            <td class="input-group-text">Catalog ID</td>
                            <td><input type="text" class="form-control" name="catalogID" readonly value="${updateCatalog.catalogID}"/></td>
                        </tr>
                        <tr>
                            <td class="input-group-text">Catalog Name</td>
                            <td><input type="text" class="form-control" name="catalogName" value="${updateCatalog.catalogName}"/></td>
                        </tr>
                        <tr>
                            <td class="input-group-text">Title</td>
                            <td><input type="text" class="form-control" name="catalogTitle" value="${updateCatalog.catalogTitle}"/></td>
                        </tr>
                        <tr>
                            <td class="input-group-text">Catalog Status</td>
                            <td>
                                <select class="form-select" id="inputGroupSelect01" name="catalogStatus">
                                    <option value="true" ${updateCatalog.catalogStatus?"selected":""}>Hoạt động</option>
                                    <option value="false" ${updateCatalog.catalogStatus?"":"selected"}>Không hoạt động</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
