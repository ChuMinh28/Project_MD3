                        ...
                        <nav class="navbar navbar-expand-lg bg-light">
                            <div class="container-fluid">
                                ...
                                <form class="d-flex" role="search" method="get">
                                    <input class="form-control me-2 fst-italic" name="searchName"
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a type="button" class="update btn btn-info" href="<%=request.getContextPath()%>/ProductServlet?action=GetById&&productID=${pro.productID}">Detail</a>
                                </td>
                                <td>
                                    <a type="button" class="update btn btn-warning" href="<%=request.getContextPath()%>/ProductServlet?action=Update&&productID=${pro.productID}" >Edit</a>
                                </td>
                                <td>
                                    <a type="button" class="delete btn btn-danger" href="<%=request.getContextPath()%>/ProductServlet?action=Delete&&productID=${pro.productID}" >Delete</a>
                                </td>
                            </tr>
                            </c:forEach>
                            </tbody>
