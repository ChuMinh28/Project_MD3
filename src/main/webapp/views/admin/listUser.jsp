          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped text-center">
              ...
              <tr>
                ...
                <td>${user.address}</td>
                <td>${user.phone}</td>
                <td>${user.userStatus?"Hoạt Động":"Khóa"}</td>
                <td><fmt:formatDate value="${user.created}" pattern="dd-MM-yyyy"/></td>
                <td>
                  <a type="button" class="update btn btn-success" href="<%=request.getContextPath()%>/userController/unlock?userID=${user.userID}">Unlock</a>
                </td>
                <td>
                  <a type="button" class="update btn btn-danger" href="<%=request.getContextPath()%>/userController/delete?userID=${user.userID}">Lock</a>
                </td>
              </tr>
              </c:forEach>
              </tbody>
