                            ...
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                            <img class="d-block w-100" src="<%=request.getContextPath()%>/views/img/product-img/${productDetail.productImage}" alt="First slide">
                                    </div>
                                </div>
                            </div>
                            <c:forEach items="${productDetail.listImageLink}" var="link">
                                <img class="d-inline-flex w-25" src="<%=request.getContextPath()%>/views/img/product-img/${link}" alt="${proDetail.productName}"/>
                            </c:forEach>
                        </div>
                    </div>
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                ...
                                <p><c:out value="${productDetail.productStatus==true?'Còn Hàng':'Hết Hàng'}"></c:out></p>
                            </div>
                            <p>Số lượng: ${productDetail.quantity}</p>
                            <div class="short_overview my-4">
                                <h6>${productDetail.productTitle}</h6>
                            </div>
                            <div class="short_overview my-4">
