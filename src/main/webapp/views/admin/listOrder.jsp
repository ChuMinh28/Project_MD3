                        ...
                        <nav class="navbar navbar-expand-lg bg-light">
                            <div class="container-fluid">
                                <a class="navbar-brand" href="<%=request.getContextPath()%>/ProductServlet?action=NewProduct">
                                    <button hidden class="btn btn-success">+ Add new Product</button>
                                </a>
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <tr>
                                ...
                                <td>${order.orderStatus?"Đã thanh toán":"Chưa thanh toán"}</td>
                                <td>$${order.totalAmount}</td>
                                <td>
                                    <a type="button" class="update btn btn-info" href="<%=request.getContextPath()%>/OrderServlet?action=GetById&&orderID=${order.orderID}">Detail</a>
                                </td>
                                <td>
                                    <a type="button" class="delete btn btn-danger" href="<%=request.getContextPath()%>/OrderServlet?action=Update&&orderID=${order.orderID}">Update</a>
                                </td>
                            </tr>
                            </c:forEach>
                            </tbody>
